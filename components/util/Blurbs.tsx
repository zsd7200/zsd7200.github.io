...
export const blurbs: Array<ReactNode> = [
  ...
  <span key="blurb-5">Want me to take a look at your controller? <Image src="/portfolio/controller.svg" alt="Gamecube Controller" width={30} height={21} className="inline-flex" /></span>,
]